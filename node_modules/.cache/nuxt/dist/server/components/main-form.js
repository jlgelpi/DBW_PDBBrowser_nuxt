...
/* harmony default export */ var mainFormvue_type_script_lang_js_ = ({
  ...
  methods: {
    submit() {
      if (this.idCode) {
        this.$router.push({
          "path": "/jspdb/show?id=" + this.idCode
        });
      } else if (this.seqQuery) {
        this.$router.push({
          "path": "/jspdb/blast?query=" + this.seqQuery
        });
      } else {
        this.$router.push({
          "path": "/jspdb/search?query=" + JSON.stringify(this.$data)
        });
      }
    },
